...
final class PokemonRewardUtil {
	...
	private static boolean isLegendaryOrMythical(Object pokemon)
	{
		...
		return isTrue(callNoArg(pokemon, "isLegendary")) || isTrue(callNoArg(pokemon, "isMythical")) || isTrue(callNoArg(species, "isLegendary"))
			|| isTrue(callNoArg(species, "isMythical")) || hasLabel(species, "legendary") || hasLabel(species, "mythical");
	}
