...
/**
 * Counts completed Cobblemon player trades for quests.
...
public final class PokemonTradeListener {
	...
	private static HookResult tryHookCobblemonEvents(String name) {
		String[] holders = {
			...
			"com.cobblemon.mod.common.api.events.trade.TradeEvents",
			"com.cobblemon.mod.common.api.events.trade.TradeEventHandler",
			"com.cobblemon.mod.common.api.events.trade.TradeEventHandlers"
		};
	...
	private static final class TradeHandler implements InvocationHandler {
		...
		public Object invoke(Object proxy, Method method, Object[] args) {
			...
			try {
				...
				ServerPlayerEntity p1 = resolvePlayer(event,
					"getPlayer", "getPlayer1", "getFirst", "getFirstPlayer", "getInitiator", "getSender"
				);
				ServerPlayerEntity p2 = resolvePlayer(event,
					"getOtherPlayer", "getPlayer2", "getSecond", "getSecondPlayer", "getReceiver"
				);
				...
				if (p1 == null || p2 == null) {
					...
					if (server != null) {
						if (p1 == null && u1 != null) p1 = server.getPlayerManager().getPlayer(u1);
						if (p2 == null && u2 != null) p2 = server.getPlayerManager().getPlayer(u2);
					}
				}
